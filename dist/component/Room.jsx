...
const Room = ({ name, localAudioTrack, localVideoTrack, setJoined, darkMode, setDarkMode, toggleDarkMode }) => {
    const [lobby, setLobby] = (0, react_1.useState)(true);
    const [socket, setSocket] = (0, react_1.useState)(null);
    const [sendingPc, setSendingPc] = (0, react_1.useState)(null);
    const [receivingPc, setReceivingPc] = (0, react_1.useState)(null);
    const [remoteVideoTrack, setRemoteVideoTrack] = (0, react_1.useState)(null);
    const [remoteAudioTrack, setRemoteAudioTrack] = (0, react_1.useState)(null);
    const [remoteMediaStream, setRemoteMediaStream] = (0, react_1.useState)(null);
    const [sendingDc, setSendingDc] = (0, react_1.useState)(null);
    const [receivingDc, setReceivingDc] = (0, react_1.useState)(null);
    const [chat, setChat] = (0, react_1.useState)("");
    const [chatMessages, setChatMessages] = (0, react_1.useState)([]);
    const [partnerName, setPartnerName] = (0, react_1.useState)("");
    ...
    function handleLeave() {
        ...
        setLobby(true);
        sendingPc === null || sendingPc === void 0 ? void 0 : sendingPc.close();
        setSendingPc(pc => {
            if (pc) {
        ...
        setSendingPc(null);
        receivingPc === null || receivingPc === void 0 ? void 0 : receivingPc.close();
        setReceivingPc(pc => {
            if (pc) {
                pc.onicecandidate = null;
                pc.ontrack = null;
    ...
    (0, react_1.useEffect)(() => {
        const socket = new WebSocket("wss://ccme03ln92.execute-api.eu-north-1.amazonaws.com/production/"); // Replace with your WebSocket server URL
        ...
        const handleMessage = async (event) => {
            ...
            if (data.type === "send-offer") {
                ...
                setLobby(false);
                setSendingPc(pc => {
                    pc === null || pc === void 0 ? void 0 : pc.setRemoteDescription(remoteSdp).catch((error) => console.log("error adding remote description on sender side", error));
                    return pc;
                });
            }
                ...
                if (recipientType == "sender") {
                    setReceivingPc(pc => {
                        ...
                        pc === null || pc === void 0 ? void 0 : pc.addIceCandidate(candidate);
                    ...
                    setSendingPc(pc => {
                        ...
                        console.log("adding ice to receiver started", pc === null || pc === void 0 ? void 0 : pc.remoteDescription);
                        pc === null || pc === void 0 ? void 0 : pc.addIceCandidate(candidate);
    ...
    return (<div className={`flex flex-col h-screen ${darkMode ? 'bg-gray-900 text-white' : 'bg-gray-200 text-gray-800'}`}>
        <Navbar_1.Navbar darkMode={darkMode} toggleDarkMode={toggleDarkMode} name={name}/>
        <div className={`bg-${darkMode ? 'gray-900' : 'gray-200'} text-${darkMode ? 'white' : 'black'} h-full flex flex-col items-center justify-center py-8`}>
            ...
            if (message[0] === "You") {
                return (<div key={index} className="flex flex-col items-start mb-4">
                ...
                return (<div key={index} className="flex flex-col items-end mb-4">
